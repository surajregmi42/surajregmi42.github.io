...
Machine learning-based classification models generally use softmax function at the end to convert a real number to normalized values. The real number might vary anywhere in a real number line. When we want to assign a value which might act as 
