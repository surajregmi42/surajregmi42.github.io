...
## Publications
* **Regmi, S.** (2023). Unsupervised Image Segmentation in Satellite Imagery Using Deep Learning. The University of
Alabama in Huntsville.
* Bearss, M., Hemming, N., **Regmi, S.**, Alonso, J., Roark, N., Di, V. Petty, M. (2022). Learning to Win Strike Force
One with Autonomy.
* Banick, R., **Regmi, S.**, Sarma, N. (2022). Exploring smartphone data to estimate mobility in India.
* World Bank, 2019. Nepal Development Update, December 2019: Envisioning a Future Data Ecosystem in Federal Nepal.
* Heyns, A., Banick, R., **Regmi, S.** (2021). Roads Development Optimization for All-Season Service Accessibility
Improvement in Rural Nepal Using a Novel Cost-Time Model and Evolutionary Algorithm. World Bank PRWP.
* Banick, R., Heyns, A., **Regmi, S.** (2021). Evaluation of rural roads construction alternatives according to seasonal
service accessibility using a novel multi-modal cost-time model . Journal of Transport Geography, 93, [103057].
* Dixit, A. **Regmi, S.** (2021). Use of alternative data: High frequency readout of the situation–COVID policies,
mobility, and R-Number. arXiv preprint arXiv:2109.00050, 2021 - arxiv.org.
